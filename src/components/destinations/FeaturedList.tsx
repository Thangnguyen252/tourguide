...
const featuredDestinations = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1559592440-7f1533241f67?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 3,
    ...
    image:
      "https://images.unsplash.com/photo-1563720743-f661ca3959bc?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 4,
    title: "Landmark 81",
    ...
    image:
      "https://images.unsplash.com/photo-1621350630606-2580556da6c8?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 5,
    ...
    image:
      "https://images.unsplash.com/photo-1585233632311-6673a5a75503?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 6,
    ...
    image:
      "https://images.unsplash.com/photo-1543884846-5e048384fec1?q=80&w=800&auto=format&fit=crop",
  },
];
    ...
    <section className="mb-20">
      <div className="flex items-end justify-between mb-8">
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">
          Featured in{" "}
          <span className="text-blue-600 font-heading">Ho Chi Minh City</span>
        </h1>
        <Link
          href="#"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        // Trong file FeaturedList.tsx, tìm đến đoạn return và sửa lại như sau:
